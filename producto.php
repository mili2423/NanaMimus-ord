...
<head>
    ...
    <title><?php echo htmlspecialchars($producto['nombre']); ?> | Nana Mimus</title>
...
<body class="body-producto-detalle">
    ...
    <div class="main-wrapper">
        <nav class="breadcrumbs">
            <a href="indexNanaMimus.php">Inicio</a> / <span class="current"><?php echo htmlspecialchars($producto['nombre']); ?></span>
        </nav>
        ...
        <div class="contenedor-detalle-producto">
            <div class="imagen-producto-wrapper">
                <img src="<?php echo htmlspecialchars($producto['imagen1']); ?>" alt="<?php echo htmlspecialchars($producto['nombre']); ?>" class="img-principal">
            ...
            <div class="info-producto-wrapper">
                ...
                <div class="actions-row">
                    ...
                    <button class="btn-fav" data-id="<?php echo $producto['id']; ?>" onclick="toggleFavorito(<?php echo $producto['id']; ?>, '<?php echo addslashes($producto['nombre']); ?>', <?php echo $producto['precio']; ?>, '<?php echo addslashes($producto['imagen1']); ?>')">
                        <i class="fa-regular fa-heart"></i>
                    </button>
                </div>
            </div>
